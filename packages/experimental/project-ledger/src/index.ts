 ...
 * read, the project replay audit, and the owner evidence digest. Compiling,
 ...
 * doctoring, listing plans, reading item reviews, auditing replay parity, and
 * digesting owner evidence never execute verifier commands.
 */
