 ...
 * readiness recomputation with ledger-side cycle detection, and the generic
 * work-status transition writer. Compiling, importing, replaying, and reading
 * readiness never execute verifier commands and never activate a plan.
 */
