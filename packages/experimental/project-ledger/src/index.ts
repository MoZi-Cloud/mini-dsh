...
export { DEFAULT_ACTIVATE_ACTOR_REF, DEFAULT_DRIFT_ACTOR_REF, DEFAULT_SUPERSEDE_ACTOR_REF, PLAN_VERSION_STATUSES, BaselineDriftError, PlanActivationError, PlanSupersedeError, activatePlanVersion, recordBaselineDrift, supersedePlanVersion, type ActivatePlanVersionOptions, type BaselineDrift, type BaselineDriftErrorCode, type ObservedBaseline, type PlanActivationErrorCode, type PlanSupersedeErrorCode, type PlanVersionActivation, type PlanVersionStatus, type PlanVersionSupersede, type RecordBaselineDriftOptions, type SupersededAttempt, type SupersedePlanVersionOptions, type WorkExternalBlockerId } from './versioning.js'
export {
...
export {
  ...
  reserveScope,
  type ReapedScopeReservation,
  type ReleasedScopeReservation,
  type ReapScopeReservationsOptions,
  type ReserveScopeInput,
  type ScopeReservation,
  type ScopeReservationErrorCode,
