...
| [project-ledger.md](project-ledger.md) | the Plan-as-Data ledger: the mounted `ctx.projectLedger` database, its read/write seams, and the read-only integrity views |
